...
/*Task 1: counterMaker()
  ...
  counter1 will keep track of the count. Counter 2 will not. 

  2. Which of the two uses a closure? How can you tell?
  
  counter 1 because the inner function is refeering to the information in the outter function. 

  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better? 
     
  counter1 would be preferable for keeping track of the count as it increases. Counter2 would be better for just doing a singular count.    
*/
